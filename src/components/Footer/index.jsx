      ...
      >
        <div class="col-span-2">
          <div>
            ...
            Explore the world with our intuitive travel app. Plan seamless itineraries, discover hidden gems, and book effortlessly. 
            </p>
          </div>
        </div>
        ...
        <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form class="w-full">
            <label for="UserEmail " style={{color:"#181F3B"}}   > Sign up Newsletter </label>
